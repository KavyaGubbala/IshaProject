    ...
    stages {
       ...
       /* stage('Test2') {
        ...
        stage('Email Notification'){
            steps {
                emailext (to: 'aditi.pandey@sadhguru.org', replyTo: 'aditi.pandey@sadhguru.org', subject: "Email Report from - '${env.JOB_NAME}' ", body: readFile("target/surefire-reports/emailable-report.html"), mimeType: 'text/html');         
            }
...
/**  
         ...
         */
         ...
         always {  
             mail bcc: '', body: readFile("target/surefire-reports/emailable-report.html"), mimeType: 'text/html',  from: 'aditi.pandey@sadhguru.org', replyTo: '', subject: "${env.JOB_NAME} Build#: ${env.BUILD_NUMBER} Console Output: ${env.BUILD_URL}/console", to: 'aditi.pandey@sadhguru.org'
             
         }  

   /* always {  
             mail bcc: '', body: readFile("target/surefire-reports/emailable-report.html"), mimeType: 'text/html', cc: '', from: 'aditi.pandey@sadhguru.org', replyTo: '', subject: "${env.JOB_NAME} Build Number: ${env.BUILD_NUMBER} Build: ${env.BUILD_URL} Console Output: ${env.BUILD_URL}/console", to: 'aditi.pandey@sadhguru.org'
